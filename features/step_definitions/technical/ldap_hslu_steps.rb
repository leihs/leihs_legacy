...
Given(/^an LDAP response object for HSLU is mocked$/) do
    ...
    normal_user_hash = {samaccountname: ['normal_user'],
                        ...
                        usncreated: ['75556046'],
                        sn: ['Benutzer'],
                        dn:                       ['CN=Test Benutzer testuser,OU=ma_nopol,OU=p_ma,OU=p_user,OU=prod,OU=hslu,DC=campus,DC=intern'],
                        objectsid:                       ['BINARY DATA HERE'],
                        streetaddress: ['Musterstrasse 1, Postfach 999'],
                        distinguishedname:                       ['CN=Test Benutzer testuser,OU=ma_nopol,OU=p_ma,OU=p_user,OU=prod,OU=hslu,DC=campus,DC=intern'],
                        title: ['ICT-Test-Benutzer'],
                        cn: ['Test Benutzer testuser'],
                        ipphone: ['9999'],
                        badpasswordtime: ['0'],
                        memberof:                       ['CN=u_all_ad_deny,OU=p_administration,OU=p_group,OU=prod,OU=hslu,DC=campus,DC=intern'],
                        l: ['Musterstadt'],
    ...
    admin_user_hash = {samaccountname: ['admin_user'],
                        ...
                        cn: ['Test Benutzer testuser'],
                        ipphone: ['9999'],
                        memberof:                       ['CN=u_all_ad_deny,OU=p_administration,OU=p_group,OU=prod,OU=hslu,DC=campus,DC=intern', 'CN=blah,OU=diblah,OU=diblahblah,OU=p_ma,OU=p_group,OU=prod,OU=hslu,DC=campus,DC=intern'],
                        l: ['Musterstadt'],
                        objectclass: ['top', 'person', 'organizationalPerson', 'user'],
                        st: ['Luzern'],
                        c: ['CH'],
