class window.App.ReservationsExplorativeAddController extends Spine.Controller
  ...
  setupModal: =>
    @el = $ App.Render "manage/views/reservations/explorative_add_dialog", {startDate: @startDate, endDate: @endDate}
